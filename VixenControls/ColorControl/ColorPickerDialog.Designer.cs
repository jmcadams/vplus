namespace CommonControls
{
  partial class ColorPickerDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.colorEditor = new CommonControls.ColorEditor();
      this.colorGrid = new CommonControls.ColorGrid();
      ...
      this.loadPaletteButton.Image = global::CommonControls.Properties.Resources.palette_load;
      ...
      this.savePaletteButton.Image = global::CommonControls.Properties.Resources.palette_save;
      ...
      this.screenColorPicker.Image = global::CommonControls.Properties.Resources.eyedropper;
      ...
      this.colorGrid.CellBorderStyle = CommonControls.ColorCellBorderStyle.None;
      this.colorGrid.EditMode = CommonControls.ColorEditingMode.Both;
      this.colorGrid.Location = new System.Drawing.Point(12, 176);
      this.colorGrid.Name = "colorGrid";
      this.colorGrid.Padding = new System.Windows.Forms.Padding(0);
      this.colorGrid.Palette = CommonControls.ColorPalette.Paint;
      this.colorGrid.SelectedCellStyle = CommonControls.ColorGridSelectedCellStyle.Standard;

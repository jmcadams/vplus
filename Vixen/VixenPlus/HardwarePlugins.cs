namespace Vixen
{
    ...
    {
        private static Dictionary<string, IHardwarePlugin> m_pluginCache = new Dictionary<string, IHardwarePlugin>();
                ...
                try
                {
                    ...
                    foreach (Type type in assembly.GetExportedTypes())
                    {
                        foreach (Type type2 in type.GetInterfaces())
                        {
                            ...
                            {
                                IHardwarePlugin plugin = (IHardwarePlugin) Activator.CreateInstance(type);
        ...
        {
            List<IHardwarePlugin> list = new List<IHardwarePlugin>();

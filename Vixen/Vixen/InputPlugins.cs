namespace Vixen
{
    ...
    internal class InputPlugins : HardwarePlugins
    {
        ...
        {
            return HardwarePlugins.FindPlugin(pluginName, Paths.InputPluginPath, "IInputPlugin");
        }

        public static IHardwarePlugin FindPlugin(string pluginName, bool uniqueInstance)
        {
            return HardwarePlugins.FindPlugin(pluginName, uniqueInstance, Paths.InputPluginPath, "IInputPlugin");
        }

        public static List<string> LoadPluginNames()
        {
            return HardwarePlugins.LoadPluginNames(Paths.InputPluginPath, "IInputPlugin");
        }

        public static List<IHardwarePlugin> LoadPlugins()
        {
            return HardwarePlugins.LoadPlugins(Paths.InputPluginPath, "IInputPlugin");
        }

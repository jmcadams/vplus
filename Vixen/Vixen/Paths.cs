namespace Vixen
{
    ...
    public static class Paths
    {
        ...
        private static string m_dataPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), Vendor.ProductName);

        public static string AddinPath
        {
            get
            {
                return Path.Combine(BinaryPath, "AddIns");
            }
        }
        ...
        public static string AudioPath
        {
            get
            {
                return Path.Combine(DataPath, "Audio");
            }
        }
        ...
        public static string BidirectionalPluginPath
        {
            get
            {
                return Path.Combine(PluginBasePath, "Bidirectional");
            }
        }
        ...
        public static string CurveLibraryPath
        {
            get
            {
                return Path.Combine(LibraryPath, "Curves");
            }
        }
        ...
        public static string DebugDumpFilePath
        {
            get
            {
                return Path.Combine(DataPath, "debug.txt");
            }
        }
        ...
        public static string ImportExportPath
        {
            get
            {
                return Path.Combine(DataPath, "Imports and Exports");
            }
        }
        ...
        public static string InputPluginPath
        {
            get
            {
                return Path.Combine(PluginBasePath, "Input");
            }
        }
        ...
        public static string LibraryPath
        {
            get
            {
                return Path.Combine(DataPath, "Libraries");
            }
        }
        ...
        public static string OutputPluginPath
        {
            get
            {
                return Path.Combine(PluginBasePath, "Output");
            }
        }
        ...
        public static string PluginBasePath
        {
            get
            {
                return Path.Combine(BinaryPath, "Plugins");
            }
        }
        ...
        public static string ProfilePath
        {
            get
            {
                return Path.Combine(DataPath, "Profiles");
            }
        }
        ...
        public static string ProgramPath
        {
            get
            {
                return Path.Combine(DataPath, "Programs");
            }
        }
        ...
        public static string RoutinePath
        {
            get
            {
                return Path.Combine(DataPath, "Routines");
            }
        }
        ...
        public static string ScriptModulePath
        {
            get
            {
                return Path.Combine(BinaryPath, "Script Modules");
            }
        }
        ...
        public static string SourceFilePath
        {
            get
            {
                return Path.Combine(DataPath, "Source Files");
            }
        }
        ...
        public static string TimerTraceFilePath
        {
            get
            {
                return Path.Combine(DataPath, "timers.trace");
            }
        }
        ...
        public static string TriggerPluginPath
        {
            get
            {
                return Path.Combine(PluginBasePath, "Trigger");
            }
        }
        ...
        public static string UIPluginPath
        {
            get
            {
                return Path.Combine(PluginBasePath, "UI");
            }
        }
    }
}

        ...
        public static string String(RESULT errcode)
        {
            switch (errcode)
            {
                ...
                case RESULT.ERR_INTERNAL:
                    return "An error occured that wasnt supposed to.  Contact support. ";
                ...
                case RESULT.ERR_TOOMANYCHANNELS:
                    return "The sound created exceeds the allowable input channel count.  This can be increased with System::setMaxInputChannels. ";
                ...
                case RESULT.ERR_UPDATE:
                    return "On PS2, System::update was called twice in a row when System::updateFinished must be called first. ";

...
namespace RGBLEDAddIn {
	public partial class MainDialog {
		...
		private void InitializeComponent() {
			...
			this.lblIntensity.Location = new Point(0xb3, 0x45);
			this.lblIntensity.Name = "label4";
			this.lblIntensity.Size = new Size(0x5f, 13);
			this.lblIntensity.TabIndex = 8;
			this.lblIntensity.Text = "Channel intensities";
			this.numericUpDownBlue.Location = new Point(0xfb, 0x1f);
			int[] bitsB = new int[4];
			bitsB[0] = 0xff;
			this.numericUpDownBlue.Maximum = new decimal(bitsB);
			...
			int[] bitsG = new int[4];
			bitsG[0] = 0xff;
			this.numericUpDownGreen.Maximum = new decimal(bitsG);
			...
			int[] bitsR = new int[4];
			bitsR[0] = 0xff;
			this.numericUpDownRed.Maximum = new decimal(bitsR);

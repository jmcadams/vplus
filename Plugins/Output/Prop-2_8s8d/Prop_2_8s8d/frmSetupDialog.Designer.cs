namespace Prop_2_8s8d {
	...
	public partial class frmSetupDialog {
		...
		private void InitializeComponent() {
			...
			int[] analogMinMax = new int[4];
			analogMinMax[0] = 200;
			this.nudAnaMin.Maximum = new decimal(analogMinMax);
			...
			int[] thresholdMin = new int[4];
			thresholdMin[0] = 1;
			this.numericUpDownThreshold.Minimum = new decimal(thresholdMin);
			...
			thresholdValue[0] = 50;
			this.numericUpDownThreshold.Value = new decimal(thresholdValue);

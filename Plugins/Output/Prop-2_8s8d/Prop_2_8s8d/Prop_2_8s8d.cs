namespace Prop_2_8s8d
{
    ...
    public class Prop_2_8s8d : IEventDrivenOutputPlugIn, IOutputPlugIn, IHardwarePlugin, IPlugIn, ISetup
    {
        private int m_analogMax;
        private int m_analogMin;
        private float m_multiplier;
        private byte[] m_packet = new byte[] { 0x56, 0x58, 0x4e, 0, 0, 0, 0, 0, 0, 0, 0, 0 };
        ...
        public string Description
        {
            get
            {
                return "EFX-TEK 8+8 firmware (Prop-2).";
            }
        }

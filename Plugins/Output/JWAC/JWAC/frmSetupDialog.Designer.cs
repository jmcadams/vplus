namespace JWAC {
	...
	public partial class frmSetupDialog {
		...
		private void InitializeComponent() {
			...
			int[] bitsAnaMax = new int[4];
			bitsAnaMax[0] = 250;
			this.nudAnaMax.Maximum = new decimal(bitsAnaMax);
			int[] bitsAnaMaxMin = new int[4];
			bitsAnaMaxMin[0] = 200;
			this.nudAnaMax.Minimum = new decimal(bitsAnaMaxMin);
			this.nudAnaMax.Name = "nudAnaMax";
			this.nudAnaMax.Size = new Size(0x2a, 20);
			this.nudAnaMax.TabIndex = 4;
			int[] bitsAnaMaxValue = new int[4];
			bitsAnaMaxValue[0] = 200;
			this.nudAnaMax.Value = new decimal(bitsAnaMaxValue);
			this.nudAnaMin.Location = new Point(0x94, 0x2c);
			int[] bitsAnaMinMin = new int[4];
			bitsAnaMinMin[0] = 50;
			this.nudAnaMin.Minimum = new decimal(bitsAnaMinMin);
			this.nudAnaMin.Name = "nudAnaMin";
			this.nudAnaMin.Size = new Size(0x2a, 20);
			this.nudAnaMin.TabIndex = 3;
			int[] bitsAnaMinValue = new int[4];
			bitsAnaMinValue[0] = 100;
			this.nudAnaMin.Value = new decimal(bitsAnaMinValue);
			this.numericUpDownThreshold.Location = new Point(0x94, 0x12);
			int[] bitsUpDownMin = new int[4];
			bitsUpDownMin[0] = 1;
			this.numericUpDownThreshold.Minimum = new decimal(bitsUpDownMin);

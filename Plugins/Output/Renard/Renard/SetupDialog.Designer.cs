namespace Renard {
	...
	public partial class SetupDialog {
		...
		private void InitializeComponent() {
			...
			this.label6.Location = new Point(22, 26);
			...
			this.comboBoxProtocolVersion.Location = new Point(0x73, 23);
			...
			this.buttonSerialSetup.Location = new Point(25, 0x6b);
			...
			this.checkBoxHoldPort.Location = new Point(25, 0x3a);

namespace GenericSerial {
	...
	internal partial class SetupDialog {
		...
		private void InitializeComponent() {
			...
			this.numericUpDownPort.Location = new Point(0x34, 23);
			...
			this.label2.Location = new Point(0x77, 25);
			...
			this.comboBoxBaud.Location = new Point(0x9d, 22);
			this.comboBoxBaud.Name = "comboBoxBaud";
			this.comboBoxBaud.Size = new Size(0x4f, 0x15);
			this.comboBoxBaud.TabIndex = 3;
			this.checkBoxHeader.AutoSize = true;
			this.checkBoxHeader.Location = new Point(13, 26);

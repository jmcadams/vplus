...
private NumericUpDown numericUpDownPulseWidth;
		...
		private void InitializeComponent()
		{
			...
			this.labelPulses.Location = new Point(0x97, 27);
			...
			this.numericUpDownPulseWidth.Location = new Point(0x72, 25);
			...
			this.label2.Location = new Point(12, 27);
			this.label2.Name = "label2";
			this.label2.Size = new Size(0x60, 13);
			this.label2.TabIndex = 0;
			this.label2.Text = "Hold clock high for";
			this.buttonSetupPort.Location = new Point(60, 29);
			this.buttonSetupPort.Name = "buttonSetupPort";
			this.buttonSetupPort.Size = new Size(0x4b, 23);
